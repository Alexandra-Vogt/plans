...
***** DONE Memorize OSI model
***** DONE Read about how packets work
***** DONE Practice IP address calculations
***** DONE Study server design fundamentals and HTTP error codes
***** DONE Study DNS system

*** W3 D1
    The goal of this day is to go into OOP
***** DONE Go over UML again
***** DONE Wiki walk on OOP concepts more and fundamental design concepts
***** DONE Wiki walk on how classes are implemented in various languages
***** DONE Wiki walk on how garbage collection works in modern languages
...
***** DONE Create program for the bot to fetch data from discord
***** DONE Create program for the bot to send schedules to discord

*** W3 D4
    The goal of this day is to study type systems.
***** DONE Wiki walk on category theory
***** DONE Wiki walk on type systems
***** DONE Wiki walk on set theory
